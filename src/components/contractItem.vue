      ...
      <span v-show="currentHistoryType=='1'" >
         <!-- 判断奇数为 平仓前单子 -->
          ...
          <span v-show="list.tradeType=='OPEN_UP'" class="green_text ">
            ...
            <span class="">
              多开 {{list.pairsName}}永续 {{list.leverNum | toFixed(2)}}X
            </span>
          ...
          <span v-show="list.tradeType=='CLOSE_UP'" class="green_text ">
            ...
            <span class="red_text">
               {{list.closeType=='BURST'?'多强平':'平多'}} {{list.pairsName}}永续 {{list.leverNum | toFixed(2)}}X
            </span>
          ...
          <span v-show="list.tradeType=='OPEN_DOWN'" class="green_text ">
            <span class="red_text ">
             空开 {{list.pairsName}}永续 {{list.leverNum | toFixed(2)}}X
            </span>
          </span>

          <span v-show="list.tradeType=='CLOSE_DOWN'" class="green_text ">
            <span >
              {{(list.closeType=='BURST'?'空强平':'平空')}} {{list.pairsName}}永续 {{list.leverNum | toFixed(2)}}X
            </span>
          </span>
       ...
       <span v-show="currentHistoryType!='1'" >
          ...
          <span v-show="list.tradeType=='OPEN_DOWN'" class="green_text red_text">空开 {{list.pairsName}}永续 {{list.leverNum | toFixed(2)}}X</span>
      </span>
      <!-- 持仓 -->
      <!-- <span v-else>
            ...
            <div :class="type=='history'?'bold_num size14':''">
                ...
                <div v-else>
                  ...
                  >
                    ...
                    <span class="dark_text"  v-if="list.tradeType=='OPEN_DOWN' || list.tradeType=='OPEN_UP'">
                        ---
                    </span>
