  ...
  <div>
    ...
    <div id="new-markdown" class="editor-layer">
      <div class="editor-top">
        <input class="editor-title form-control" type="text" placeholder="title"
        ...
        <div class="dropdown select-category">
          ...
          <ul class="dropdown-menu">
            <li @click="newMarkdown.categoryId = 1"><a>work</a></li>
            <li @click="newMarkdown.categoryId = 2"><a>life</a></li>
            <li @click="newMarkdown.categoryId = 3"><a>study</a></li>
          </ul>
        </div>
        <ul class="tools">
      ...
      <textarea class="text-content form-control" placeholder="content"
    ...
    <div id="new-doodle" class="editor-layer">
      <div class="editor-top">
        ...
        <div class="dropdown select-category">
          ...
          <ul class="dropdown-menu">
            <li @click="newDoodle.categoryId = 1"><a>work</a></li>
            <li @click="newDoodle.categoryId = 2"><a>life</a></li>
            <li @click="newDoodle.categoryId = 3"><a>study</a></li>
          </ul>
        </div>
        <ul class="tools">
    ...
    <div id="edit-markdown" class="editor-layer">
      ...
      <textarea class="text-content form-control" placeholder="content"></textarea>
    </div>
