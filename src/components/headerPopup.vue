      ...
      <div class="ceng">
        ...
        <div class="top_middle pad_l_r_35 c222 size14">
          <div v-if="isLogin">
            ...
            <div class="pad_t_8 pad_b_15 size12 flex align_center">
              ...
              <button class="copyUid" v-clipboard="userId" @click="fz"></button>
              <!-- <img
          ...
          <div class="list pad_t_23">
            ...
            <div
              class="item hei56 linehei40 flex-between align_center"
              @click="goRealname"
            >
              <div>
                <img
                  src="./../assets/images/user/qihuo.png"
                  class="wid17 hei17 a_sub inline_block"
                />
                <span class="pad_l_16">{{ i18n.qihuo }}</span>
              </div>
              <img
                src="../assets/images/user/yjt.png"
                srcset
                class="wid15 hei15"
              />
            </div>
            ...
            >
              <div>
                <img
                  src="./../assets/images/user/niuxiong.png"
                  alt
                  class="wid17 hei17 a_sub inline_block"
                />
                <span class="pad_l_16">{{ i18n.niux }}</span>
              </div>
              <img
                src="../assets/images/user/yjt.png"
                srcset
            ...
            >
              <div>
                <img
                  src="./../assets/images/user/shenshou.png"
                  alt
                  class="wid17 hei17 a_sub inline_block"
                />
                <span class="pad_l_16">{{ i18n.shens }}</span>
              </div>
              <img
                src="../assets/images/user/yjt.png"
                srcset
            ...
            >
              <div>
                <img
                  src="./../assets/images/user/sfrz.png"
                  alt
                  class="wid17 hei17 a_sub inline_block"
                />
            ...
            >
              <div>
                <img
                  src="./../assets/images/user/help.png"
                  class="wid17 hei17 a_sub inline_block"
                  alt
                />
            ...
            >
              <div>
                <img
                  src="./../assets/images/user/aqzx.png"
                  alt
                  class="wid17 hei17 a_sub inline_block aqzx"
                />
                <span class="pad_l_16">{{ i18n.aqzx }}</span>
              </div>
              <img
                src="../assets/images/user/yjt.png"
                srcset
            ...
            >
              <div>
                <img
                  src="./../assets/images/user/qiehuan.png"
                  alt
                  class="wid17 hei17 a_sub inline_block aqzx"
                />
                <span class="pad_l_16">{{ i18n.qhhl }}</span>
              </div>
              <img
                src="../assets/images/user/yjt.png"
                srcset
        ...
        <!-- <div class="top_bottom bor_t">
          <van-row class="hei00 linehei54">
            ...
            <van-col
              :span="12"
              class="hei00 a_center"
              @click="invitationRegister"
            >
              <img
                src="./../assets/images/user/invitationRegister.png"
                class="hei17 wid17 inline"
                alt
              />
