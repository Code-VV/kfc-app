<template>
  <div class="container_common chooseArea flex_column">
    <div class="searchBox">
      <van-search :placeholder="$t('xzgj.qsr')" v-model="keyWord" @input="searchInput()" />
    </div>
...
export default {
  created() {
    ...
    for(let i=0; i<cityList.length; i++){
      ...
      // cityList[i].name.indexOf(')')
     cityList[i].name= cityList[i].name.substring(cityList[i].name.indexOf('(')+1,cityList[i].name.indexOf(')'))
      // cityList[i].name=0
