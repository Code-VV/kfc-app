...
v-clipboard:error="onError" -->
    ...
    <!-- <div class="addressPic">
      <van-button
        style="width: 120%; background-color: #169e78"
        @click="showPopup"
        id="saveAudit"
        type="info"
        >{{ $t("recharge.tjsh") }}</van-button
      >
      <van-popup class="popup" v-model="show">
        ...
        <van-button type="primary" color="#171E28" @click="ssaveAudit()"
          >确认提交</van-button
        >
      </van-popup>
    </div> -->
    ...
    <van-dialog
      v-model="popShow"
      class="transactionPop c333"
      :title="i18n.cztx"
      :showConfirmButton="false"
      show-cancel-button
      :cancelButtonText="i18n.wzdl"
    >
      <div class="pad_15">
        {{ i18n.sxfsqfs }}
        <span class="orange_text"
          >{{ i18n.czje }}{{ min_rechange_value }}{{ currency }}</span
        >
        {{ i18n.bndz }}
      </div>
    </van-dialog>
