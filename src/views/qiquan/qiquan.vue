...
<div class="quotesDetail">
    ...
    <header class="headers flex header_custom" :style="{ paddingTop: safeTop+'px'}">
        ...
        <div class="titlesBox flex">
            ...
            <span class="span" v-if="type=='contract'">{{currentName}}</span>
    ...
    <div class="quotesContent">
        ...
        <div class="timeEchart">
            <ul class="tabbar">
                ...
                <li class="items" @click="switchTab('mores')">
                    <span :class="moreText!='更多'?'c_blue':''">{{moreText}}</span>
                    <img src="../../assets/images/home/iconMore.png" alt srcset class="loadMore" />
                </li>
                <li class="items" :class="{'cur':tabIndex=='deep'}" @click="switchTab('deep')">深度图</li>
        ...
        <!-- <van-tabs v-model="listIndex" class="tabBox bold">
            <van-tab :title="type=='contract'?'委托列表':'委托挂单'">
                <div class="entrustList">
                    <van-row gutter="4" class="title">
                        <van-col span="3">买盘</van-col>
                        <van-col span="5" v-if="type=='contract'">数量</van-col>
                        <van-col span="5" v-else>数量({{currentName.split('/')[0]}})</van-col>
                        <van-col span="8" class="center_text">价格({{currentName.split('/')[1]}})</van-col>
                        <van-col span="5" v-if="type=='contract'" class="right_text">数量</van-col>
                        <van-col span="5" v-else class="right_text">数量({{currentName.split('/')[0]}})</van-col>
                        <van-col span="3" class="right_text">卖盘</van-col>
                    </van-row>
                    <div class="detail">
            ...
            <van-tab :title="type=='contract'?'最新成交':'成交'" class="dealBox">
                <div>
                    <van-row gutter="5" class="title">
                        <van-col span="8">时间</van-col>
                        <van-col span="5" class="center_text">方向</van-col>
                        <van-col span="5" class="center_text">价格{{ '('+currentName.split('/')[1]+')'}}</van-col>
                        <van-col span="6" class="right_text" v-if="type=='contract'">数量(手)</van-col>
                        <van-col span="6" class="right_text" v-else>数量({{currentName.split('/')[0]}})</van-col>
                    </van-row>
                </div>
                <div class="dealList">
              ...
              time: 1578465941988
              tradeType: "OPEN_UP"-->
                        <van-col v-show="item.tradeType=='OPEN_UP'" span="5" class="center_text green_text">买入</van-col>
                        <van-col v-show="item.tradeType=='OPEN_DOWN'" span="5" class="center_text orange_text">卖出</van-col>
            ...
            <div style="width"></div>
            <van-tab title="简介" class="introduction" v-if="pairsDetail.result==true">
