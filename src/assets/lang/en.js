module.exports = {
    ...
    realname: { IDverification: 'Identity Verification' },
    form: {
        dl: 'Login',
        zc: 'Register',
        sj: 'Mobile',
        ...
        yx: 'Mailbox',
        hmyzhyzc: "Don't have a NASDAQ account yet? Hurry up and go",
        ...
        yjyzhydl: 'Already have a NASDAQ account? Hurry up and go',
        ...
        Enter_phoneOrEmail: 'Please enter your phone number/email',
    ...
    invitation: {
        ...
        rules_title: 'NASDAQ rebate rules description',
    ...
    shareBox: {
        ...
        Invite_join: 'Invite you to join NASDAQ, long press to identify the QR code',
    ...
    bind: { title1: 'Bind mobile phone', title2: 'Bind Mailbox' },
    change: {
    ...
    login: {
        login: 'Login',
        register: 'Register',
        Hurry_register: "Don't have a NASDAQ account yet? Hurry up and go",
        Already_register: 'Already have a NASDAQ account? Hurry up and go',
    ...
    agreement: {
        ...
        User_rights_3: "Users have the right to participate in various online and offline activities provided by the NASDAQ organization;",

        User_rights_4: "Users have the right to enjoy other various services provided by NASDAQ in accordance with NASDAQ website regulations.",
        User_rights_5: "Users who disagree with the modification of this agreement or are dissatisfied with the services of NASDAQ can exercise the following rights:",
        wrfw: '(1) Stop using NASDAQ network services;',
        tgkf: '(2) Inform NASDAQ to stop its services through customer service and other channels. After the end of the service, the user s right to use the NASDAQ service is immediately terminated.In this case,NASDAQ is not obligated to transmit any unprocessed information or unfinished services to users or any third parties that are not directly related.',
        ...
        yhyw02: '2. Users shall not maliciously register NASDAQ station accounts through any means, including but not limited to multiple account registrations for profit, speculation, cash out, awards, etc. Users shall not steal other user accounts. If the user violates the above regulations, NASDAQ has the right to directly take all necessary measures, including but not limited to deleting the content posted by the user, canceling the user’s star ratings, honors and virtual wealth obtained on the website, suspending or sealing user accounts, and canceling due to violations The benefits obtained, until the user is held accountable through legal means. ',
        yhyw03: '3. Users are prohibited from using NASDAQ in any form as a venue, platform or medium for engaging in various illegal activities. Without the authorization or permission of NASDAQ, users shall not use the name of this site to engage in any commercial activities, nor shall they use NASDAQ as a place, platform or medium for commercial activities in any form. If the user violates the above regulations, NASDAQ has the right to directly take all necessary measures, including but not limited to deleting the content posted by the user, canceling the star ratings, honors and virtual wealth obtained by the user on the website, suspending or sealing user accounts, and canceling due to violations. The benefits obtained, until the user is held accountable through legal means. ',
        yhyw04: '4. All information released by users in various forms on NASDAQ should comply with national laws and regulations and other relevant regulations on the website, comply with social public order and good customs, and do not infringe the legitimate rights and interests of any third party, otherwise the user shall bear it. All legal consequences arising therefrom, and the losses NASDAQ suffered as a result, have the right to recover from the user. According to this agreement, we grant you a limited, non-exclusive, non-transferable permission to access and use NASDAQ services only for the approved purpose of NASDAQ license. You promise that you will not copy, disseminate, distribute, sell, license, reverse engineer, modify, publish or participate in the transfer or sale of creative derivative works in any other way, or use any NASDAQ content in any other way. ',
        yhyw05: '5. All rights of this website service and related software, website and technology belong to NASDAQ, and users are not allowed to transfer the rights or benefits of this service. ',
        ...
        yhyw07: '7. Strictly abide by the website s trading rules when using the NASDAQ website, including but not limited to:',
        ...
        yhyw072: '(2) If the user submits a transaction order after confirming that the transaction information is correct, it means that the user authorizes NASDAQ to act as an agent for the user to carry out the corresponding transaction matching. NASDAQ will automatically complete the matching transaction when all user authorization conditions are met without prior notice to the user , The user knows and agrees with this. The user has the right to revoke or modify the entrustment at any time before the entrustment has not reached the transaction. ',
        yhxx: 'Four. User Information Protection Policy',
        yhxx1: '1. You agree to the use of your information by NASDAQ in accordance with the NASDAQ User Information Protection Policy. The NASDAQ user information mentioned in this agreement refers to information that complies with laws, regulations and related regulations, and complies with the following scope:',
        yhxx11: '(1) Personal information provided to NASDAQ when users register for NASDAQ;',
        yhxx12: '(2) When users use NASDAQ services, participate in website activities or visit website pages, NASDAQ automatically receives and records user browser or mobile client data, including but not limited to IP address,',
        yhxx13: '(3) NASDAQ legally obtained user personal information from business partners;',
        yhxx14: '(4) Other personal information obtained by NASDAQ through legal means. ',
        yhxx2: '2, NASDAQ promises: NASDAQ will not disclose the user s password, name, mobile phone number and other non-public information to any third party without statutory reasons or the user s prior permission.Under the following legal circumstances,the user s personal information will be partially or fully disclosed:',
        ...
        yhxx23: '(3) Other disclosures made by NASDAQ in accordance with relevant laws and regulations. ',
        mztk: 'Five, exemption clause',
        mztk1: '1, NASDAQ, as the third-party platform of the "network service provider", does not guarantee that the information and services on the website platform can fully meet the needs of users. For users receiving NASDAQ services',
        mztk2: '2, based on the peculiarities of the Internet, NASDAQ does not guarantee that the service will not be interrupted, nor does it guarantee the timeliness and safety of the service, and does not assume any liability not caused by NASDAQ. NASDAQ strives to enable users to safely access and use this website, but NASDAQ does not declare or guarantee that this website or its servers are free of viruses or other potentially harmful factors; therefore,',
        mztk3: '3. NASDAQ is not responsible for the failure to save, modify, delete or save the information posted by users. We are not responsible for typographical errors and negligence on the website that are not deliberately caused by NASDAQ. NASDAQ has the right but no obligation to improve or correct omissions and errors in any part of this website. ',
        mztk4: '4. Unless NASDAQ expressly agrees in writing, NASDAQ will treat users in any way (including but not limited to including, via, connecting or downloading) any content information obtained from this website,',
        mztk5: '5. The user comments posted by all users in NASDAQ only represent the user s personal views, and it does not mean that this website agrees with their views or confirms their descriptions. This website does not bear any legal responsibility caused by user comments. ',
        mztk6: '6. NASDAQ has the right to delete all kinds of information in NASDAQ that does not comply with the law or agreement, and reserves the right not to notify users. ',
        mztk7: '7. All notices sent to users, NASDAQ will be delivered through official page announcements, site letters, e-mails, customer service calls, mobile text messages or regular letters. Any non-NASDAQ',
        mztk8: '8. NASDAQ has the right to adjust the recharge, withdrawal, transaction and other handling fee rates according to market conditions, and has the right to decide the end of the free promotion period. ',
        ...
        xysx1: 'This agreement takes effect when the user clicks on the NASDAQ registration page to agree to register, complete the registration process, and obtain the NASDAQ account and password, and is legally binding on both NASDAQ and the user. These agreements provide for the complete understanding of the service content by both parties, and replace all previous understandings and communications related to them. ',
    ...
    about: {
        ...
        dyzs: 'NASDAQ pays attention to the protection of your personal privacy, but sometimes certain information is needed to provide you with the corresponding services, so we make a statement on the data collection and use under these circumstances. All the terms of this statement belong to one of the important parts of the "NASDAQ Digital Currency Trading Platform User Registration Agreement". Please read carefully to understand the management of personal information. ',
        dez: 'Chapter II Implementation Rules',
        dyt: 'The first collection of information',
        gs: '(1) Overview',
        gs1: 'In order to enable you to conduct transactions in an efficient and personalized process, the NASDAQ platform will, as needed, entrust the product platform party to collect/store different personal information from you through the product platform according to the different types of services provided. ',
        gs2: 'Related services include but are not limited to account registration, authentication, and your operation records in the payment system. You hereby specifically authorize the NASDAQ platform to collect your personal information, including but not limited to your name, gender, city of residence, mailing address, postal code, email, mobile phone number, phone number, ID card information, bank credit card and bank transactions Account information. ',
        sj: '(2) Collection of information on minors',
        sj1: 'The NASDAQ platform attaches great importance to the security and protection of the collection and use of personal information of minors. Any minor under the age of 16 (excluding working adults) who participates in online activities should obtain the consent of the legal guardian (hereinafter referred to as the "guardian") in advance. With the consent of the guardian, personal information of minors can be collected, but the guardian has the right to refuse further collection of the personal information of their children or ward, and has the right to review or request the deletion of the personal information of the minor. It is guaranteed that minors will not be required to provide additional personal information as a condition for allowing them to participate in online activities. ',
        jr: '(3) Cookie record',
        ...
        xxaq3: 'The relevant passwords of your account (login password, payment password, etc.) are stored on the machine in an encrypted format. The staff does not know your password and will not ask you for the password. Please keep the relevant password information carefully, especially don t tell others the password. If you accidentally leak the password, please contact the NASDAQ platform or product platform immediately or visit the product platform to change the password. ',
        mzsm: 'Article 5 Disclaimer',
        mzsm0: 'NASDAQ platform does not assume any legal responsibility for the occurrence of the following related matters:',
        mzsm1: '1, disclose your information in accordance with the "Privacy Protection Statement" and the "NASDAQ Digital Asset Derivatives Trading Platform User Registration Agreement". ',
        mzsm2: '2, when you register, you need to set the account name and password. You can only use the account with the valid password set. If you leak the password, it may cause the loss of your information and may lead to unfavorable consequences for you. When your account and password are in potential or actual danger for any reason, you should get in touch with the NASDAQ platform immediately, and you will not be responsible for this before the NASDAQ platform takes measures. ',
        mzsm3: '3. Any third party uses your personal information in accordance with the terms of service and the conditions listed in the statement, and the NASDAQ platform and product platform shall be exempt from any disputes arising therefrom. ',
        ...
        mzsm8: '8, and other exemptions listed in the terms of service and statement related to the NASDAQ platform NASDAQ platform. ',
    },
    sfrz: {
        sfrz: 'Identity Authentication',
        yrz: 'Authenticated',
    ...
    kef: {
        ...
        rhcb3: '3. Off-site deposit: Enter the deposit address provided by NASDAQ on the third-party platform, enter the deposit amount and submit it. After the third-party withdrawal request is successful, it will be credited to the account after the block confirmation is completed. ',
        ...
        najg: 'How is the NASDAQ index price calculated',
        ...
        smsyx: 'What is an USTD perpetual contract',
    ...
    gjrz: {
        zm: 'Click to upload the side with an avatar',
        fm: 'Click to upload the side with the national emblem',
