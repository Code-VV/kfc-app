module.exports = {
    ...
    invitation: {
        ...
        rules_title: 'NASDAQ rebate rules explained', // NASDAQ返佣规则说明
    ...
    shareBox: {
        ...
        Invite_join: 'Invite you to join NASDAQ, long press to identify', // 邀请你加入NASDAQ，长按识别二维码
    ...
    login: {
        ...
        Hurry_register: "Don't have a NASDAQ account? Hurry up and", // 
        Already_register: 'Already have a NASDAQ account? Hurry up and', // 已经有NASDAQ账号？赶快去
    ...
    agreement: {
        ...
        p0: 'I have carefully read the service agreement (hereinafter referred to as "this agreement"). By clicking the "Register" button or by accessing or using the Service, you agree to comply with this agreement and all additional agreements. Before you register as a NASDAQ platform user, you must carefully and carefully read and fully understand the entire content of this agreement, especially the waiver of liability for the NASDAQ platform and the terms that restrict your rights. You click the consent button on the page provided by the NASDAQ platform (for example, the button indicates "Agree to Agreement and Register" or similar text, and the page also lists the content of this agreement or a link that can effectively display the content of this agreement), that is, It means that you have confirmed that you have accepted and signed this agreement after fully reading and understanding the contents of this agreement, and mean that you and our company have reached an agreement and agree to accept all the agreed contents of this agreement, including the rules related to this agreement and NASDAQ All types of statements, rules, and instructions included in the platform that have been issued or will be released in the future (if there is no agreement in the service agreement, the corresponding contents in the various statements, rules, and instructions issued by the NASDAQ platform shall prevail). If you do not agree or do not accept all or part of this agreement, please do not register as a NASDAQ platform user and use the NASDAQ platform services.',
        risk_warning: 'Risk warning', // 风险提示
        risk_warning_1: 'Based on the great risks inherent in digital currency transactions, users should fully understand the characteristics of digital currencies themselves, transaction mechanisms, and price fluctuations before conducting digital transactions on this website. At the same time, due to the regulation and management of digital currency transactions by laws and policies, digital currency transactions may be suspended or banned at any time due to this impact. Digital currency transactions have a greater risk. Transactions or holding digital currency are likely to cause Your loss. NASDAQ will not be held responsible for this. Therefore, you should carefully consider whether to trade digital currencies or related derivatives and use leverage based on your financial situation.',

        risk_warning_2: 'NASDAQ cannot guarantee the orderly stability of the digital currency market. You should be cautious in trading digital currencies (and any other assets). Prices can fluctuate at any time. Due to price fluctuations, you may make a large profit or loss. Any digital currency or trading position may fluctuate significantly and may even become worthless.',
        ...
        User_registration_1: 'In order to use any service on this platform, you must first register your account by providing your name, email and password, and confirm acceptance of this service agreement. You promise to keep your account information and password properly, and do not allow anyone to use and guide your account to ensure that your account is not stolen. You are responsible for protecting and securing any keys, certificates, passwords, access codes, user IDs or other credentials and login information (collectively, "Passwords") provided to you. If you lose your password, you may not be able to access your account. If any unauthorized use of your password occurs, please notify NASDAQ immediately. NASDAQ will not be held liable for any liability, loss or damage caused by unauthorized use of your password. Since this site is a trading website, login passwords, withdrawal passwords, transaction passwords, and SMS passwords must not use the same password, otherwise there will be security risks and the relevant responsibilities shall be borne by the user.',

        User_registration_2: 'The user has the right to choose whether to become a NASDAQ user. If the user chooses to become a NASDAQ registered user, he can create and modify his own nickname. The naming and use of user names and nicknames shall comply with relevant laws and regulations and comply with network ethics. The username and nickname must not contain any insults, threats, obscenities, abuse, etc. that infringe on the legitimate rights and interests of others.',
        User_registration_3: 'Once the user has successfully registered and becomes a NASDAQ user, he will get the username and password, and be responsible for all activities and events that occur after logging in to the system with this username and password. Or indirect legal liability.',
        User_registration_4: 'If the user password is lost, the original password can be retrieved by the method suggested by NASDAQ. If the user finds any illegal use of the username or other security breach, he should immediately inform NASDAQ.',
        User_rights_and_obligations: 'User rights and obligations', // 用户的权利和义务

        User_rights: 'User rights', // 用户权利
        User_rights_1: 'Users have the right to obtain rewards from NASDAQ after making contributions such as publishing information in accordance with relevant website regulations;',
